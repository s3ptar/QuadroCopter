...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USB_CDC_1_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USB_CDC_1_DEVICE0_CONFIGURATION0_DESCR[67u] = {
...
*********************************************************************/
const uint8 CYCODE USB_CDC_1_STRING_DESCRIPTORS[159u] = {
/*********************************************************************
...
*********************************************************************/
const uint8 CYCODE USB_CDC_1_SN_STRING_DESCRIPTOR[2] = {
...
*********************************************************************/
const T_USB_CDC_1_EP_SETTINGS_BLOCK CYCODE USB_CDC_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[3u] = {
...
const uint8 CYCODE USB_CDC_1_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[2u] = {
0x02u, 0x0Au
};
/*********************************************************************
...
*********************************************************************/
const T_USB_CDC_1_LUT CYCODE USB_CDC_1_DEVICE0_CONFIGURATION0_TABLE[5u] = {
    {0x01u,     &USB_CDC_1_DEVICE0_CONFIGURATION0_DESCR},
    {0x03u,     &USB_CDC_1_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,    NULL},
    {0x00u,     &USB_CDC_1_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_USB_CDC_1_LUT CYCODE USB_CDC_1_DEVICE0_TABLE[3u] = {
    {0x01u,     &USB_CDC_1_DEVICE0_DESCR},
    {0x00u,    NULL},
    {0x01u,     &USB_CDC_1_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_USB_CDC_1_LUT CYCODE USB_CDC_1_TABLE[1u] = {
    {0x01u,     &USB_CDC_1_DEVICE0_TABLE}
};
    ...
    *  USB_CDC_1_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE USB_CDC_1_MSOS_DESCRIPTOR[USB_CDC_1_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   USB_CDC_1_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE USB_CDC_1_MSOS_CONFIGURATION_DESCR[USB_CDC_1_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 USB_CDC_1_idSerialNumberStringDescriptor[USB_CDC_1_IDSN_DESCR_LENGTH];
