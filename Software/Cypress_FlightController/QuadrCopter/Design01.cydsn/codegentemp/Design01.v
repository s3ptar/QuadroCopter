...
module top ;
    ...
    USBFS_v3_20_0 USB_CDC_1 (
        .sof(Net_1),
        .vbusdet(1'b0));
    defparam USB_CDC_1.epDMAautoOptimization = 0;
	...
	wire [0:0] tmpOE__ITG3200_Pin_net;
	wire [0:0] tmpIO_0__ITG3200_Pin_net;
	wire [0:0] tmpINTERRUPT_0__ITG3200_Pin_net;
	electrical [0:0] tmpSIOVREF__ITG3200_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		ITG3200_Pin
		 (.oe(tmpOE__ITG3200_Pin_net),
		  .y({1'b0}),
		  .fb({Net_82}),
		  .io({tmpIO_0__ITG3200_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__ITG3200_Pin_net),
		  .interrupt({tmpINTERRUPT_0__ITG3200_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ITG3200_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
