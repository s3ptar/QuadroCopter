...
/* UART_DMA_Clock */
#define UART_DMA_Clock__CFG0 CYREG_CLKDIST_DCFG1_CFG0
#define UART_DMA_Clock__CFG1 CYREG_CLKDIST_DCFG1_CFG1
#define UART_DMA_Clock__CFG2 CYREG_CLKDIST_DCFG1_CFG2
#define UART_DMA_Clock__CFG2_SRC_SEL_MASK 0x07u
#define UART_DMA_Clock__INDEX 0x01u
#define UART_DMA_Clock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define UART_DMA_Clock__PM_ACT_MSK 0x02u
#define UART_DMA_Clock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define UART_DMA_Clock__PM_STBY_MSK 0x02u

/* UART_DMA_TIMER */
#define UART_DMA_TIMER_TC_ISR__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define UART_DMA_TIMER_TC_ISR__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define UART_DMA_TIMER_TC_ISR__INTC_MASK 0x20000u
#define UART_DMA_TIMER_TC_ISR__INTC_NUMBER 17u
#define UART_DMA_TIMER_TC_ISR__INTC_PRIOR_NUM 7u
#define UART_DMA_TIMER_TC_ISR__INTC_PRIOR_REG CYREG_NVIC_PRI_17
#define UART_DMA_TIMER_TC_ISR__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define UART_DMA_TIMER_TC_ISR__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
#define UART_DMA_TIMER_TimerHW__CAP0 CYREG_TMR0_CAP0
#define UART_DMA_TIMER_TimerHW__CAP1 CYREG_TMR0_CAP1
#define UART_DMA_TIMER_TimerHW__CFG0 CYREG_TMR0_CFG0
#define UART_DMA_TIMER_TimerHW__CFG1 CYREG_TMR0_CFG1
#define UART_DMA_TIMER_TimerHW__CFG2 CYREG_TMR0_CFG2
#define UART_DMA_TIMER_TimerHW__CNT_CMP0 CYREG_TMR0_CNT_CMP0
#define UART_DMA_TIMER_TimerHW__CNT_CMP1 CYREG_TMR0_CNT_CMP1
#define UART_DMA_TIMER_TimerHW__PER0 CYREG_TMR0_PER0
#define UART_DMA_TIMER_TimerHW__PER1 CYREG_TMR0_PER1
#define UART_DMA_TIMER_TimerHW__PM_ACT_CFG CYREG_PM_ACT_CFG3
#define UART_DMA_TIMER_TimerHW__PM_ACT_MSK 0x01u
#define UART_DMA_TIMER_TimerHW__PM_STBY_CFG CYREG_PM_STBY_CFG3
#define UART_DMA_TIMER_TimerHW__PM_STBY_MSK 0x01u
#define UART_DMA_TIMER_TimerHW__RT0 CYREG_TMR0_RT0
#define UART_DMA_TIMER_TimerHW__RT1 CYREG_TMR0_RT1
#define UART_DMA_TIMER_TimerHW__SR0 CYREG_TMR0_SR0
...
#define LED_on_Board__0__INTTYPE CYREG_PICU2_INTTYPE1
#define LED_on_Board__0__MASK 0x02u
#define LED_on_Board__0__PC CYREG_PRT2_PC1
#define LED_on_Board__0__PORT 2u
#define LED_on_Board__0__SHIFT 1u
#define LED_on_Board__AG CYREG_PRT2_AG
#define LED_on_Board__AMUX CYREG_PRT2_AMUX
#define LED_on_Board__BIE CYREG_PRT2_BIE
#define LED_on_Board__BIT_MASK CYREG_PRT2_BIT_MASK
#define LED_on_Board__BYP CYREG_PRT2_BYP
#define LED_on_Board__CTL CYREG_PRT2_CTL
#define LED_on_Board__DM0 CYREG_PRT2_DM0
#define LED_on_Board__DM1 CYREG_PRT2_DM1
#define LED_on_Board__DM2 CYREG_PRT2_DM2
#define LED_on_Board__DR CYREG_PRT2_DR
#define LED_on_Board__INP_DIS CYREG_PRT2_INP_DIS
#define LED_on_Board__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define LED_on_Board__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define LED_on_Board__LCD_EN CYREG_PRT2_LCD_EN
#define LED_on_Board__MASK 0x02u
#define LED_on_Board__PORT 2u
#define LED_on_Board__PRT CYREG_PRT2_PRT
#define LED_on_Board__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define LED_on_Board__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define LED_on_Board__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define LED_on_Board__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define LED_on_Board__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define LED_on_Board__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define LED_on_Board__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define LED_on_Board__PS CYREG_PRT2_PS
#define LED_on_Board__SHIFT 1u
#define LED_on_Board__SLW CYREG_PRT2_SLW
