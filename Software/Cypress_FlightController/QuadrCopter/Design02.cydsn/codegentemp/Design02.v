...
module top ;
    ...
    Timer_v2_80_1 UART_DMA_TIMER (
        ...
        .tc(Net_29),
        .clock(Net_17));
    defparam UART_DMA_TIMER.CaptureCount = 2;
    defparam UART_DMA_TIMER.CaptureCounterEnabled = 0;
    defparam UART_DMA_TIMER.DeviceFamily = "PSoC5";
    defparam UART_DMA_TIMER.InterruptOnCapture = 0;
    defparam UART_DMA_TIMER.InterruptOnTC = 1;
    defparam UART_DMA_TIMER.Resolution = 16;
    defparam UART_DMA_TIMER.SiliconRevision = "0";

	wire [0:0] tmpOE__LED_on_Board_net;
	wire [0:0] tmpFB_0__LED_on_Board_net;
	wire [0:0] tmpIO_0__LED_on_Board_net;
	wire [0:0] tmpINTERRUPT_0__LED_on_Board_net;
	electrical [0:0] tmpSIOVREF__LED_on_Board_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_on_Board
		 (.oe(tmpOE__LED_on_Board_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_on_Board_net[0:0]}),
		  .io({tmpIO_0__LED_on_Board_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_on_Board_net),
		  .interrupt({tmpINTERRUPT_0__LED_on_Board_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_on_Board_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_isr_v1_0
		#(.int_type(2'b10))
		UART_DMA_TIMER_TC_ISR
		 (.int_signal(Net_30));
