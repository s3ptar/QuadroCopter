...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x480006C8u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x480006D0u)
...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 128u, 0x17u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U1_BASE) },	/* TD 22 */
		...
		{ 128u, 0x1Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_ROUTE_BASE) },	/* TD 29 */
		{ 128u, 0x1Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_ROUTE_BASE + 0x00000080u) },	/* TD 30 */
		...
		{ 128u, 0x22u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI1_BASE + 0x00000080u) },	/* TD 33 */
		{ 128u, 0x23u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE) },	/* TD 34 */
		{ 128u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE + 0x00000080u) },	/* TD 35 */
	};
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_UDB_1_5_1_CONFIG_VAL),	/* TD 22 */
		...
		(const void *)(BS_UDBSWITCH_1_5_VAL),	/* TD 29 */
		(const void *)(BS_UDB_2_5_HV_ROUTING_VAL),	/* TD 30 */
		(const void *)(BS_DSI3_3_HV_ROUTING_VAL),	/* TD 31 */
		(const void *)(BS_DSISWITCH_1_4_VAL),	/* TD 32 */
		(const void *)(BS_DSI3_4_HV_ROUTING_VAL),	/* TD 33 */
		(const void *)(BS_DSISWITCH_1_5_VAL),	/* TD 34 */
		(const void *)(BS_DSI3_5_HV_ROUTING_VAL),	/* TD 35 */
	};
