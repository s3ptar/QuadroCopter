// ======================================================================
// SSD1306.v generated from TopDesign.cysch
// 10/31/2021 at 11:01
...
module I2C_v3_50_1 (
	...
	cy_clock_v1_0
		#(.id("8a668258-bc44-4762-b2ec-13d13c783dbc/5ece924d-20ba-480e-9102-bc082dcdd926"),
...
module top ;
    ...
    cy_annotation_universal_v1_0 S6 (
        .connect({
            Net_3,
            Net_5
        })
    );
    defparam S6.comp_name = "SwitchSPST_v1_0";
    defparam S6.port_names = "T1, T2";
    defparam S6.width = 2;
	...
	wire [0:0] tmpOE__USR_BTN_net;
	wire [0:0] tmpFB_0__USR_BTN_net;
	wire [0:0] tmpIO_0__USR_BTN_net;
	electrical [0:0] tmpSIOVREF__USR_BTN_net;
	...
	cy_psoc3_pins_v1_10
		...
		USR_BTN
		 (.oe(tmpOE__USR_BTN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__USR_BTN_net[0:0]}),
		  .io({tmpIO_0__USR_BTN_net[0:0]}),
		  .siovref(tmpSIOVREF__USR_BTN_net),
		  .interrupt({Net_15}),
		  .annotation({Net_5}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
	...
	assign tmpOE__USR_BTN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    cy_annotation_universal_v1_0 D5 (
        .connect({
            Net_8,
            Net_10
        })
    );
    defparam D5.comp_name = "LED_v1_0";
    defparam D5.port_names = "A, K";
    defparam D5.width = 2;
	...
	wire [0:0] tmpOE__USR_LED_net;
	wire [0:0] tmpFB_0__USR_LED_net;
	wire [0:0] tmpIO_0__USR_LED_net;
	wire [0:0] tmpINTERRUPT_0__USR_LED_net;
	electrical [0:0] tmpSIOVREF__USR_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		USR_LED
		 (.oe(tmpOE__USR_LED_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__USR_LED_net[0:0]}),
		  .io({tmpIO_0__USR_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__USR_LED_net),
		  .interrupt({tmpINTERRUPT_0__USR_LED_net[0:0]}),
		  .annotation({Net_11}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__USR_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_0 DBG_OUT (
        .clock(1'b0),
        .cts_n(1'b0),
        .reset(1'b0),
        .rts_n(Net_22),
        ...
        .tx_en(Net_30),
        .tx_interrupt(Net_31));
    defparam DBG_OUT.Address1 = 0;
    defparam DBG_OUT.Address2 = 0;
    defparam DBG_OUT.EnIntRXInterrupt = 0;
    defparam DBG_OUT.EnIntTXInterrupt = 0;
    defparam DBG_OUT.FlowControl = 0;
    defparam DBG_OUT.HalfDuplexEn = 0;
    defparam DBG_OUT.HwTXEnSignal = 1;
    defparam DBG_OUT.NumDataBits = 8;
    defparam DBG_OUT.NumStopBits = 1;
    defparam DBG_OUT.ParityType = 0;
    defparam DBG_OUT.RXEnable = 1;
    defparam DBG_OUT.TXEnable = 1;
	...
	wire [0:0] tmpOE__SSD1306_Reset_net;
	wire [0:0] tmpFB_0__SSD1306_Reset_net;
	wire [0:0] tmpIO_0__SSD1306_Reset_net;
	wire [0:0] tmpINTERRUPT_0__SSD1306_Reset_net;
	electrical [0:0] tmpSIOVREF__SSD1306_Reset_net;

	cy_psoc3_pins_v1_10
		#(.id("a4d50034-45d9-4e3e-8fda-2c4ad7fa4ee6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SSD1306_Reset
		 (.oe(tmpOE__SSD1306_Reset_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SSD1306_Reset_net[0:0]}),
		  .io({tmpIO_0__SSD1306_Reset_net[0:0]}),
		  .siovref(tmpSIOVREF__SSD1306_Reset_net),
		  .interrupt({tmpINTERRUPT_0__SSD1306_Reset_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SSD1306_Reset_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("249cd0b3-0960-47d9-88d9-3484f277fbc8"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
