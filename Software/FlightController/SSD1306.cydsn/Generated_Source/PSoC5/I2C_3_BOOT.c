...
*
* Global variables:
*  I2C_3_slWriteBuf - The global variable used to store a received
*                                command.
*  I2C_3_slReadBuf -  The global variable used to store a response.
...
*
* Global variables:
*  I2C_3_slWriteBuf - The global variable used to store a
*                                received command.
*
*******************************************************************************/
